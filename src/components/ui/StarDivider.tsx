...
// blurred glow bridging where each line meets the star. Pass align="left" for
// a left-anchored variant (star, then a single line trailing right) instead
// of the symmetric centered version, for left-aligned heading blocks.
export default function StarDivider({ lineWidth = 100, gap = 10, style, align = 'center' }: {
  lineWidth?: number
  gap?: number
  ...
  if (align === 'left') {
    return (
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-start', gap, ...style }}>
        <Star />
