    ...
    <>
      ...
      >
        ...
        <div style={{ maxWidth: 600, margin: '0 auto', padding: '0 32px' }}>
          ...
          {/* Divider */}
          <div style={{ height: '0.5px', background: 'rgba(255,255,255,0.07)', marginBottom: 32 }} />

          {/* ── Form ── */}
          {submitted ? (
            <div style={{ textAlign: 'center', padding: '32px 0' }}>
              <p style={{ fontFamily: "'Playfair Display', serif", fontSize: 22, color: '#fff', marginBottom: 10 }}>
                Thank you.
              </p>
              <p style={{ fontFamily: "'Inter', sans-serif", fontSize: 12, color: 'rgba(255,255,255,0.35)' }}>
            ...
            <form onSubmit={submit} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 12 }}>
                {[
                  { label: 'Full Name',     name: 'name',  type: 'text',  ph: 'Full Name' },
                  { label: 'Email Address', name: 'email', type: 'email', ph: 'mail@company.com' },
                ].map(f => (
                  <div key={f.name}>
              ...
              <button
                ...
                style={{
                  ...
                  background: '#fff', border: 'none', borderRadius: 3,
                  fontFamily: "'Inter', sans-serif",
