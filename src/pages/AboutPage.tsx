...
export default function AboutPage() {
  ...
  return (
    <div className="fixed inset-0 bg-black flex flex-col items-start justify-end px-5 pb-10 sm:px-20 sm:pb-16 fade-in">
      <button
        onClick={() => navigate('/')}
        className="fixed top-5 left-4 sm:top-8 sm:left-12 font-subtitle text-[10px] tracking-[0.14em] uppercase text-white hover:opacity-60 transition-opacity flex items-center gap-2"
      >
